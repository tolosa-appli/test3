...
import { Calendar, Users, MapPin, Edit, Trash2, Cookie, Circle, Upload, ImageIcon, MessageSquare, Send, Copy, Heart, GraduationCap } from 'lucide-react';
...
const registeredGirlsOutings: Sortie[] = [
    { id: 'g1', title: 'Brunch & Papotage', theme: 'Gastronomie', date: '2024-08-11T11:00:00Z', location: 'Café des Rêves, Toulouse', description: 'Un moment convivial entre filles autour d\'un délicieux brunch.', participants: 8, maxParticipants: 8, image: 'https://placehold.co/600x400.png', dataAiHint: 'brunch cafe', type: 'girls-only' },
];

const registeredStudentOutings: Sortie[] = [
    { id: 's1', title: 'Soirée intégration BDE', theme: 'Fête', date: '2024-09-12T21:00:00Z', location: 'Salle Le Phare, Tournefeuille', description: 'La plus grosse soirée de l\'année pour bien commencer !', participants: 250, maxParticipants: 300, image: 'https://placehold.co/600x400.png', dataAiHint: 'student party', type: 'students-only' },
];
