...
import { Terminal, Mail, ThumbsUp, ExternalLink, Languages, MessageSquareText, User, Bookmark, Archive, CalendarDays, MessageSquare, LayoutDashboard, LifeBuoy } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setOpenMobile(true)}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <LayoutDashboard />
                <span>Toutes les rubriques</span>
              </CardTitle>
              <CardDescription>Accédez à toutes les sections de l'application.</CardDescription>
            </CardHeader>
             <CardContent>
              <p className="text-sm text-muted-foreground">Ouvrir le menu de navigation principal.</p>
            </CardContent>
        </Card>
        <Card>
          <CardHeader>
        ...
        <Link href="/help">
          <Card className="h-full hover:shadow-lg transition-shadow cursor-pointer">
            <CardHeader>
              ...
              <CardDescription>Besoin d'aide ? Trouvez des réponses ici.</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">Consultez notre FAQ et contactez le support.</p>
            </CardContent>
          </Card>
        </Link>
      </div>
