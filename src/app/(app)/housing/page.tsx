...
import { housingData, type HousingAd } from './data';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';

const housingImageMapping: Record<string, string> = {
    'default': 'http://bilingue31.free.fr/Logement_Logement_OK.jpg',
    'Colocation': 'http://bilingue31.free.fr/Logement_colocation_OK.jpg',
    'Studio': 'http://bilingue31.free.fr/Logement_Studio_OK.jpg',
    'T1': 'http://bilingue31.free.fr/Logement_T1_OK.jpg',
    'T2': 'http://bilingue31.free.fr/Logement_T2_OK.jpg',
    'T3': 'http://bilingue31.free.fr/Logement_T3_OK.jpg',
    'T4': 'http://bilingue31.free.fr/Logement_T4_OK.jpg',
    'T5': 'http://bilingue31.free.fr/Logement_T5_OK.jpg',
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
                 <div className="grid gap-2">
                    <Label htmlFor={`housingType-${type}`}>Type de logement</Label>
                    <Controller
                        name="housingType"
                        control={control}
                        render={({ field }) => (
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <SelectTrigger id={`housingType-${type}`}><SelectValue placeholder="Sélectionnez..." /></SelectTrigger>
                                <SelectContent>
                    ...
                    />
                    {errors.housingType && <p className="text-sm text-destructive">{errors.housingType.message}</p>}
                </div>
                <div className="grid gap-2">
...
export default function HousingPage() {
    ...
    const getHousingImage = (ad: HousingAd) => {
        return housingImageMapping[ad.housingType] || housingImageMapping.default;
    };
                            ...
                            {adsToDisplay.map(ad => (
                                <Card key={ad.id} className="overflow-hidden flex flex-col">
                                    ...
                                    <div className="p-4 flex-grow">
                                        <CardTitle className="text-lg mb-2">{ad.isColocation ? `Colocation à ${ad.city}` : `${ad.housingType} à ${ad.city}`}</CardTitle>
