...
import {
    ...
    Briefcase, GraduationCap, FileText, Sparkles, Clock3, BarChart, Link as LinkIcon, Gamepad2
} from 'lucide-react';
...
import { type NetworkGameAd, networkGamesData } from '@/app/(app)/network-games/data';
...
// Images for game platforms, similar to network-games page
...
export default function MyAdsPage() {
    ...
    const myNetworkGames = networkGamesData.filter(ad => ad.user.name === currentUser.name);
                ...
                <CardContent className="p-6">
                    <Tabs defaultValue="ads" className="w-full">
                        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-7">
                            ...
                            <TabsTrigger value="network-games">Jeux en réseau</TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="network-games" className="pt-6">
                            <h2 className="text-2xl font-bold font-headline mb-4">Mes annonces de Jeux en réseau</h2>
                            {myNetworkGames.length > 0 ? (
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {myNetworkGames.map(ad => (
                                        <Card key={ad.id} className="overflow-hidden flex flex-col group">
                                            <div className="relative h-48 w-full">
                                                <Image 
                                                    src={platformImages[ad.platform] || ad.image} 
                                                    alt={ad.gameTitle} 
                                                    layout="fill" 
                                                    objectFit="cover" 
                                            ...
                                            <CardHeader>
                                                ...
                                                <CardDescription>{ad.gameGenre}</CardDescription>
                                            </CardHeader>
                            ...
                            ) : <EmptyState message="Vous n'avez publié aucune annonce de jeu en réseau." />}
                        </TabsContent>
